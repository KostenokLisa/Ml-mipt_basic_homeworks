...
Original file is located at
    https://colab.research.google.com/drive/1zzYpdjT-EeurdRuTWYeDWINMN9UXtAg_
...
class Sequential(Module):
    ...
    def updateOutput(self, input):
        ...
        for i in range(len(self.modules)):
            cur_input = self.modules[i].forward(cur_input)
    ...
    def backward(self, input, gradOutput):
        ...
        """
        # Your code goes here. ################################################
        cur_output = gradOutput
        for i in range(len(self.modules)-1, 0, -1):
            cur_output = self.modules[i].backward(self.modules[i - 1].output, cur_output)
        self.gradInput = self.modules[0].backward(input, cur_output)
        return self.gradInput
...
class SoftMax(Module):
    ...
    def updateGradInput(self, input, gradOutput):
        ...
        for i in range(len(input)):
            cur_grad = -np.outer(self.output[i], self.output[i])
            cur_grad += np.diag(self.output[i])
            self.gradInput[i] = gradOutput[i] @ cur_grad 
        return self.gradInput
...
class LogSoftMax(Module):
    ...
    def updateOutput(self, input):
        ...
        # Your code goes here. ################################################
        inp_exp = np.exp(self.output)
        self.output -= np.log(np.sum(inp_exp, axis=1, keepdims=True))
        return self.output
...
class BatchNormalization(Module):
    ...
    def updateGradInput(self, input, gradOutput):
        ...
        self.gradInput /= (N * np.sqrt(batch_var + self.EPS))
        return self.gradInput
...
class Dropout(Module):
    ...
    def updateGradInput(self, input, gradOutput):
        # Your code goes here. ################################################
        self.gradInput = self.mask * gradOutput / (1 - self.p)
        return self.gradInput
...
class SoftPlus(Module):
    ...
    def updateGradInput(self, input, gradOutput):
        # Your code goes here. ################################################
        self.gradInput = gradOutput / (1 + np.exp((-1) * input))
        return self.gradInput
...
class ClassNLLCriterionUnstable(Criterion):
    ...
    def updateOutput(self, input, target): 
        ...
        self.output = -np.sum(target * probs) / target.shape[0]
        return self.output
